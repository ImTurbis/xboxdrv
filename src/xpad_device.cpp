...
XPadDevice xpad_devices[] = {
    ...
    // { GAMEPAD_XBOX,             0xffff, 0xffff, "Chinese-made Xbox
    // Controller" },
    ...
    //{ GAMEPAD_XBOX360_PLAY_N_CHARGE, 0x045e, 0x028f, "Microsoft Xbox 360
    // Play&Charge Kit" },
    ...
    {GAMEPAD_XBOX360, 0x0738, 0x4718,
     "Mad Catz Street Fighter IV FightStick SE"},
    {GAMEPAD_XBOX360, 0x0738, 0x4738,
     "Mad Catz Wired Xbox 360 Controller (SFIV)"},
    {GAMEPAD_XBOX360, 0x0738, 0xbeef,
    ...
    {GAMEPAD_XBOX360_WIRELESS, 0x045e, 0x0291,
     "Xbox 360 Wireless Receiver (XBOX)"},  // RF Module from the Xbox360
    {GAMEPAD_XBOX360_WIRELESS, 0x045e, 0x0719,
     "Xbox 360 Wireless Receiver"},  // official Wireless Receiver
    {GAMEPAD_XBOX360_WIRELESS, 0x045e, 0x02a9,
     "Xbox 360 Wireless Receiver (unofficial)"},  // fake but fully compatible
    ...
    // { GAMEPAD_XBOX_MAT,         0x1430, 0x8888, "TX6500+ Dance Pad (first
    // generation)" }, // just a HID device, not Xbox1

    {GAMEPAD_FIRESTORM, 0x044f, 0xb304,
     "ThrustMaster, Inc. Firestorm Dual Power"},
    {GAMEPAD_FIRESTORM_VSB, 0x044f, 0xb312,
     "ThrustMaster, Inc. Firestorm Dual Power (vs b)"},
